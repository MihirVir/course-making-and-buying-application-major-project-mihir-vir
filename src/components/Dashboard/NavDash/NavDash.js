    ...
    <>
      <section className="nav-dash-section bg-neutral-900">
        <div className="nav-dash-contaner">
          <div
            ref={menuRef}
            style={isFull ? { width: "180px" } : { width: "80px" }}
            className="welcome-nav-dash-info-container"
          >
            <MenuIcon
              onClick={handleMenuOn}
              style={
                isFull
                  ? { marginRight: ".4em", marginLeft: ".4em" }
                  : { marginRight: "0" }
              }
              className="nav-dash-burger-menu"
            />
            <span
              style={
                isFull
              ...
              className="nav-dash-welcome-txt"
            >
              Welcome, Mihir
            </span>
          </div>
