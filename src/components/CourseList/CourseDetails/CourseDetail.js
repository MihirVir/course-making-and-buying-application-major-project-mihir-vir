        ...
        {isLoading ? (
          ...
          <>
            <div className="topic-paper-container">
              <div className="course-content-details">
                ...
                <ol className="topic-list">
                  {courseDetails.title ? (
                    courseDetails.title.map((item, idx) => {
                      return (
                        <>
                          {purchased ? (
                            <li className="course-content-li">
                              <Link to={`/course/${courseDetails._id}/${idx}`}>
                                {item}
                              </Link>
                            </li>
                          ) : (
            ...
            <div className="desc-paper-container">
              ...
              <span className="course-desc-paper-container">O</span>
              <span className="course-desc-paper-container">N</span>
              <p className="topic-paper-desc-text">
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. At
                dolores repellat adipisci iusto, laudantium veniam quidem
                recusandae quasi consectetur rerum qui similique temporibus rem
                fugit, necessitatibus totam eum harum expedita cupiditate.
                Pariatur distinctio praesentium fuga deleniti itaque,
                repellendus ex voluptatum. Incidunt, quam corrupti. Non adipisci
                hic ipsam distinctio vero officiis voluptatem, rerum veritatis
                et, nam ratione corporis asperiores dolorem quos itaque.
                Perferendis aliquam, repellendus, eaque corporis corrupti optio
                ratione, quidem doloremque repellat expedita aperiam sequi
                aspernatur. Autem deserunt officia nostrum.
              </p>
            </div>
          </>
        )}
